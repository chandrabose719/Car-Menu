...
<html lang="en">
<head>
	<title>Registeration - Welcome To UrHome</title>
	...
	<div id="main-register">
		<div class="container">
			<div class="register-content">
				<h4>User Signup</h4>
				<form method="post" action="<?php echo base_url();?>register/register_validate">
					...
					<div class="form-group col-lg-3 col-lg-offset-5 col-md-4 col-md-offset-5 col-sm-6 col-xs-12">
						<input type="submit" class="form-control btn btn-success" name="register-submit">
					</div>
					<div class="col-lg-4 col-lg-offset-5 col-md-4 col-md-offset-5 col-sm-6 col-xs-12">
						<h4>If You have an Account, <a href="<?php echo base_url();?>login">Login</a> Here!</h4>
					</div>
				</form>
			</div>
		</div>
